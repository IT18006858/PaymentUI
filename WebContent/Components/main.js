...
$(document).on(
		...
		function(event) {
			$("#hidPayIDSave").val(
					$(this).closest("tr").find('#hidPayIDUpdate').val());
			...
			$("#exp_date").val($(this).closest("tr").find('td:eq(5)').text());
...
function validatePayForm() {
	...
	if ($("#exp_date").val().trim() == "") {
		return "Insert expirary date.";
	}
	// convert to decimal price
	$("#amount").val(parseFloat(tmpCVV).toFixed(2));
	// DESCRIPTION------------------------
